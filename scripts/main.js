...
const inputTransferencia = document.querySelectorAll(
  "#formTransferencias input"
);
  ...
  switch (e.target.name) {
    ...
    case "montoRetiros":
      if (ValidarCuenta.test(e.target.value)) {
        ...
        document.querySelector("#errorValor").textContent =
          "Por favor ingrese numeros validos";
...
function validar() {
  ...
  if (
    (usuario == "BancoUnion" && clave == "1234") ||
    (usuario == "SantiagoG" && clave == "1234")
  ) {
    ...
    document.querySelector("#danger").textContent =
      "Error de credenciales te quedan " + contadorErrores + " intentos";
...
function enviarConsignacion() {
  ...
  document.querySelector("#numeroCuentaConsignar").textContent =
    document.querySelector("#numeroCuenta").value;
  document.querySelector("#valorConsignado").textContent =
    document.querySelector("#consignare").value;
  document.querySelector("#tipoCuentaConsignar").textContent =
    document.querySelector("#tipoConsignar").value;
  document.querySelector("#formaPago").textContent =
    document.querySelector("#formaDePago").value;
  document.querySelector("#fechaConsignada").textContent =
...
btn.onclick = function () {
  ...
  if (retirarDinero <= saldos) {
    ...
    document.querySelector("#valorEnviado").textContent =
      document.querySelector("#montoRetiros").value;
    document.querySelector("#fechaRetiro").textContent =
      new Date().toLocaleString();

    function tipoCuenta() {
      var textCuenta =
        opcionesCuenta.options[opcionesCuenta.selectedIndex].text;
...
botonGuardar.addEventListener("click", (e) => {
  if (nombreValido.value.length == 0) {
    document.querySelector("#errorTransferir").textContent =
    ...
    if (validarSaldoTranferencia <= saldos) {
      ...
      document.querySelector("#numeroCuentaTrans").textContent =
        document.querySelector("#numeroTransferir").value;
      document.querySelector("#valorTransferido").textContent =
        document.querySelector("#montoTranferir").value;
      document.querySelector("#fechaTransferencia").textContent =
        new Date().toLocaleString();
      document.querySelector("#bancoText").textContent =
        document.querySelector("#tipBancos").value;
      document.querySelector("#tipoCuentaText").textContent =
        document.querySelector("#tipCuenta").value;

      e.preventDefault();
      function MovimientosTranferencia(
        nombreTranferir,
        email,
        numeroTransferir,
        montoTranferir
      ...
      nuevaTranferencia = new MovimientosTranferencia(
        nombreTranferir,
        email,
        numeroTransferir,
        montoTranferir
...
botonConsignacion.addEventListener("click", (e) => {
  ...
  nuevoConsigancion = new MovimientosConsignacion(
    consignacionNueva,
    tipoConsignacion
  );
  agregarConsignacion();
